...
export function LandingFooter() {
  ...
  return (
    <>
      ...
      <section className="bg-background pt-8 pb-16 w-full relative z-10">
        <div className="container">
          <div className="bg-muted/30 rounded-3xl p-8 md:p-12 border shadow-sm text-center max-w-4xl mx-auto">
      ...
      {/* Actual Footer Links */}
      <footer id="contact" className="bg-[hsl(142,65%,22%)] pt-16 pb-8 text-white">
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
            ...
            <div className="flex flex-col gap-4">
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-lg bg-white flex items-center justify-center shrink-0 text-[hsl(142,65%,22%)]">
            ...
            <div className="flex flex-col gap-4">
              ...
              <ul className="space-y-3 flex flex-col">
                <Link to="/auth" className="text-sm text-white/90 hover:text-white hover:underline transition-colors w-fit">
                  {t("nav.login")}
                </Link>
                <a href="#faq" className="text-sm text-white/90 hover:text-white hover:underline transition-colors w-fit">
                  {t("nav.faq")}
                </a>
              </ul>
            </div>
          ...
          <div className="pt-8 border-t border-white/20 text-center flex flex-col justify-center items-center gap-4">
